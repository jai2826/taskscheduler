  ...
  return (
    <div className="flex flex-col border h-screen  bg-white items-center">
      <div className="flex flex-col w-full  sm:w-3/5 items-center justify-center border p-10 pt-20 mt-10">
        <div className="w-full lg:w-4/5 flex sm:space-x-4 sm:flex-row flex-col items-center justify-start">
          <h1 className=" font-semibold text-xl">Id of the task :</h1>
          {data && <p className="  ">{data.id}</p>}
        </div>
        <div className="w-full lg:w-4/5 flex sm:space-x-4 sm:flex-row flex-col items-center justify-start">
          <h1 className=" lg:w-1/2 font-semibold text-xl">
            Timing of the task :
          </h1>
          {data && <p className="  lg:w-1/2">{data.time}</p>}
        </div>
        <div className="w-full lg:w-4/5 flex sm:space-x-4 sm:flex-row flex-col items-center justify-start">
          <h1 className="lg:w-1/2 font-semibold text-xl">The task :</h1>
